...
class VNewsController extends VoyagerBreadController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $existingtags = DB::table('tagging_tagged')->where('taggable_id', $id)->pluck('tag_name');

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','tags','existingtags'));
    }
