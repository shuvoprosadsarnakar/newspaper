          ...
          <div class="category-submenu">
            ...
            <div class="menu-warp" style="display:none;">
              <div id="secondary-menu" class="secondary-menu">
                <ul class="">
                  @if(!$subcategories->isEmpty() and $subcategories->count()>0) @foreach($subcategories as $category)

                  <li>
                    <a href="{{route('category',['id'=>$category->id,'slug'=>$category->category_name])}}" class="text-color">{{$category->category_name}}</a>
                  </li>
                  ...
                  <div class="news-div cat-div">
                    <div class="row">
                      <div class="col-md-5 col-5">
                        <div class="img-box">
                          <a href="{{route('news',['id'=>$sp_news->id])}}" title="ছোট কাঁধে বড় দায়িত্ব">
