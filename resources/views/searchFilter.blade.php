...
/*.deshjure-padding .media h4 {
    font-size: 13px;
}
.media .news-body .tabnews-heading {
    font-size: 12.5px;
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <!-- form-->
        <div class="singlecategory-portion "style="">
        <form onSubmit="return process();" method="get" class="form-horizontal" accept-charset="UTF-8">
          {{ csrf_field() }}
            <div class="singlecategory-portion padding-top15">
              ...
              <!-- search filter area -->
               ...
               <span class="date-group">Division: </span>
                  <select style="width: 200px" name="division" class="division date-form" id="prod_cat_id">

                      <option value="0" disabled="true" selected="true">-Select-</option>
                      @foreach($division as $cat)
                          <option value="{{$cat->id}}">{{$cat->name}}</option>
                      @endforeach

                  </select>

                  <span class="date-group">District: </span>
                  <select style="width: 200px" id="district" name="district" class="district date-form">

                      <option value="0" disabled="true" selected="true">District</option>
                  </select>

                  <span class="date-group">Sub District: </span>
                  <select style="width: 200px" id="upozila"name="upozila" class="upozila date-form">

                      <option value="0" disabled="true" selected="true">Sub District</option>
                  </select>

                  <div class="data-form">
                  <input class="btn" style="background-color:#AF0031;color:white" type="submit" name="submit" value="Find">
                  </div>
                  <!-- <input type="text" class="upozila"> -->
                  ...
                  <script>
                    function process()
                    {
                    var url="Bangladesh/"+document.getElementById("upozila").value;
                    location.href=url;
                    return false;
                    }
                    </script>
                        ...
                        $(document).on('change','.district',function () {
                            ...
                            $.ajax({
                                ...
                                success:function(data){
                                    ...
                                    //a.find('.upozila').val(data.name);
                                    a.find('.upozila').html(" ");
                                   a.find('.upozila').append(op);
          ...
          <div class="col-sm-8 main-content">
                ...
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-201 -372.5 560 776.5" style="enable-background:new -201 -372.5 560 776.5;" xml:space="preserve">
                    <style type="text/css">
                        ...
                        .st4{fill:#0FC846;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st5{fill:#BE241E;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st6{fill:#e833e5;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st7{fill:#4665A9;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st8{fill:#BE241E;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st9{fill:#a6a846;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st10{fill:#BE241E;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st11{fill:#FFC000;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st12{fill:#206d36;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        .st13{fill:#8022bf;stroke:#FFFFFF;stroke-width:0.25;stroke-miterlimit:10;}
                        .st14{fill:#00A6B8;stroke:#FFFFFF;stroke-width:0.75;stroke-miterlimit:10;}
                        ...
                        <g id="rangpur">
                        <a href="{{url('All/Bangladesh/Rangpur')}}" xlink:href="{{url('All/Bangladesh/Rangpur')}}">
                        <path class="st6" d="M-152-370.6c0,0,0.5,2-2.2,3.8l-1.6,1l0.2,7.5c0,0-3.2,2.5-3.2,3.4l0.2,5c0,0,0.9,1.9,1.6,1.9l1.6-0.9l0.4-3.6
                    ...
                    QmCC" transform="matrix(0.7972 0 0 0.7972 -116.5603 -268.4205)">
                        ...
                        <g id="sylhet">
                            <a href="{{url('All/Bangladesh/Sylhet')}}" xlink:href="">
                                <path class="st11" d="M143.6-178.4l-19.2,0.6l2.3,4l-0.7,2.5l-2.8,0.8l2.3,3.3l-1.7,3.2l1.2,3l-0.5,5.8l6.8,4.5l4.9,0.1
                    ...
                    xM63OXPU7+FbyjXxYbf5StyWUP9/fYdf/xBgAC9n6lG6sC1xAAAAAElFTkSuQmCC" transform="matrix(0.8485 0 0 0.8485 198.1667 -130.2727)">
                        ...
                        <g id="khulna">
                            <a href="{{url('All/Bangladesh/Khulna')}}" xlink:href="{{url('All/Bangladesh/Khulna')}}">
                                <path class="st4" d="M25.8,164.2c0,0-0.9-4.1-0.9-4.6s0.4-2.5,0.4-2.5l-1.4-1.9c0,0-0.6-2-1-2.4c-0.4-0.4-1.4-3-1.4-3l0.6-1.1
                    ...
                    oiMrnXhTGsZ3JpLOqicJ/j/eneNPAQYAqlIjWQakbmIAAAAASUVORK5CYII=" transform="matrix(0.9259 0 0 0.9259 -78.6667 95.6296)">
                        ...
                        <g id="dhaka">
                            <a href="{{url('All/Bangladesh/Dhaka')}}" xlink:href="{{url('All/Bangladesh/Dhaka')}}">
                                <path class="st7" d="M49.4-95.6l1.6-3.1l-5.3-1.9l-2.8-3.5l-2.6-4.1l-2.2-4.1v-2.5l1.7-3.5l-0.2-6.7l-4.2-2.7l-1.8-2.3l2.8-3.2
                    ...
                    AAAAADgafgowAC4wT/jUaBZlAAAAAElFTkSuQmCC" transform="matrix(1 0 0 1 38 -86)">
                        ...
                        <g id="mymensingh">
                            <a href="{{url('All/Bangladesh/Mymensing')}}" xlink:href="{{url('All/Bangladesh/Mymensing')}}">
                                <path class="st9" d="M6.5-112l2-3l0.5-2.8l2.5-1.8l2.2-5.2L16-128h2.2l3.2,1l4.5-2.5l2.5-2l2.5-1.8l3.5-0.5l1.8,0.5l-2.8,3.2
                    ...
                    1fX6+q8AAwAexfCEjBB1ggAAAABJRU5ErkJggg==" transform="matrix(1.0957 0 0 1.0957 -3 -165.3478)">
                        ...
                        <g id="rajshahi">
                            <a href="{{url('All/Bangladesh/Rajshahi')}}" xlink:href="{{url('All/Bangladesh/Rajshahi')}}">
                    ...
                    zXvxONlKAAAAAElFTkSuQmCC" transform="matrix(0.8673 0 0 0.8673 -141.6667 -127)">
                        ...
                        <g id="borishal">
                            <a href="{{url('All/Bangladesh/Barishal')}}" xlink:href="{{url('All/Bangladesh/Barishal')}}">
                    ...
                    pNtZrT3uLWr4tnf+FmAA6KLD8jcePaIAAAAASUVORK5CYII=" transform="matrix(1.1322 0 0 1.1322 34.7654 163.216)">
                        ...
                        <g id="chittagong">
                            <a href="{{url('All/Bangladesh/Chittagong')}}" xlink:href="{{url('All/Bangladesh/Chittagong')}}">
                                <path class="st12" d="M355.6,320.6c0-1-0.1-1.6-0.1-2s-1.1-2-1.1-2l-1.8-5l-2.5-10.1l-2.9-27.5l1.2-23.9l1.4-6.1l-0.8-4.1l-1.4-3
                                ...
                                <path class="st12" d="M173.8,187.6c-0.2-0.4-0.8-0.8-1.2-1.5s-0.5-1.2-0.8-2.4s-0.6-3.8-0.6-3.8s-0.8-3.2-1.2-3.8s-2.9-3.2-2.9-3.2
                                ...
                                <path class="st12" d="M222.1,177.3c-0.4-1-0.9-2.6-1.1-3.1s-2.5-3.9-2.5-3.9l-7.6-14l-1.1-3.5l-1.1-1.6c0,0-1.1-0.6-1.5-0.6
                                ...
                                <path class="st12" d="M257.9,259.8c0-0.6,0.9-1.8,0.9-2.1s0.2-1.1,0.2-1.6s0,0,1.4-2.1s0.2-1.5,0.5-2s0-2-0.2-2.8s-0.1-1.6-0.2-2
                                s-0.6-1.5-0.6-1.5l0.4-1.5l-0.9-0.9l-1-2l-1.1,0.6l-0.4,1.8c0,0-0.8,0.4-1,0.9s-0.4,1.4-0.5,2s0,1.8,0.2,2.6s0.2,1.1,0.8,1.8
                                s-0.1,0.8-0.4,1.9s-0.1,4.1-0.1,5s-1.1,1.8-1.6,2.5s-0.8,1.8-1.4,2.6s-0.5,3.1-0.5,3.1l1.8,1.5l1.8-0.6c0,0,0.4-2.2,0.5-2.6
                                s1.1-2.2,1.1-2.2S257.9,260.4,257.9,259.8z"></path>
                                <path class="st12" d="M270.6,296.3c1.4-0.4,1.9-2,1.9-2.6s-0.4-4.4-0.4-4.9s0.1-3.2,0.1-3.2s0.6-1.8,0.6-2.8s-0.4-4.2-0.4-4.2
                                ...
                                <path class="st12" d="M194.1,148.4c0,0-0.8,0.1-1.4,0.2s-0.2,1.4-0.2,1.4l-1.1,0.1l-1,0.6c0,0,0,0.5,0,1s1,1,1,1l1.5,0.1l1.4-0.9
                                ...
                                <path class="st12" d="M179.1,173.5c-0.4-0.4-0.5-0.8-1.2-1s-1-0.8-2-0.8s-3.1,3-3.1,3v1.5c0,0,0.6,1.4,1.2,1.6s1.1,0.8,1.1,0.8
                    ...
                    tczJqAPSbQAAAABJRU5ErkJggg==" transform="matrix(1.1106 0 0 1.1106 264.7389 187.973)">
                        ...
                        <g>
                            ...
                            <path class="st1" d="M5.3-103.9l0.1,2.1l-0.9,1H3.4v2.8l-0.2,1.2c0,0,0-0.1-0.6,0.4s-1.2,0.5-1.2,1s0.2,1.1,0.2,1.1l1.8,0.4
                            ...
                            <path class="st1" d="M-5.7-127c0,0,0.6-0.6,1-0.6s1.1,0.1,1.1,0.5s0.4,0.8,0.5,1.1s0.2,0,0.2,1.2s0.1,2,0.1,2l0.8,0.6
                            ...
                            <path class="st1" d="M-0.4-127.2h1.9l0.8,0.2l0.8,0.9v0.9l0.1,1.1l0.4,1l0.8,0.8l0.5,1.1L4-121l-0.6-1l-1.1-1.4l-0.8-0.5
                            c0,0,0-0.5-0.4-0.6S0-125.3,0-125.3l-0.2-1.4v-0.5H-0.4z"></path>
                            <path class="st1" d="M-13.5-149.8l1.1-0.1l0.5-0.1l0.2,1.1l0.4,1.3l0.2,0.9l1,0.4l0.3,0.2c0,0,0.4,0.5,0.4,0.8s0.1,1.1,0,1.3
                            ...
                            <path class="st1" d="M-13.8-155.7l0.4-1.4l0.7-0.7c0,0-0.1,0.1,0.2,0.4s0.3,1.1,0.3,1.1l0.9,0.4l-0.1,1.6c0,0-0.7,1.1-0.8,1.2
