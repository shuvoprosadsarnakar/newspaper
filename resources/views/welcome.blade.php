    ...
    <div class="container-fluid">
     ...
     <nav class="navbar navbar-expand-lg navbar-light navbar-custom">
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" data-toggle="dropdown" href="#">Economics</a>
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <li><a class="dropdown-item" href="#">Abroad</a></li>
          <li><a class="dropdown-item" href="#">Abroad</a></li>
        </ul>
      </li>
      <li class="nav-item dropdown">
      ...
      <li class="nav-item dropdown">
       ...
       Entertainment
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <li><a class="dropdown-item" href="#">Tollywood</a></li>
          <li><a class="dropdown-item" href="#">Dhalywood</a></li>
          <li><a class="dropdown-item" href="#">Small Tv</a></li>
        </ul>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="http://example.com" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      Education and Training
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <li><a class="dropdown-item" href="#">Sikhha o sahitho</a></li>
          <li><a class="dropdown-item" href="#">Campus News</a></li>
     ...
     Fitcher
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
        <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" data-toggle="dropdown" href="#">Jibonsoili</a>
            <ul class="dropdown-menu">
              <a class="dropdown-item" href="#">Rasifol</a>
</ul>
          </li>
          <li><a class="dropdown-item" href="#">Health</a></li>
          <li><a class="dropdown-item" href="#">Science and It</a></li>
          <li><a class="dropdown-item" href="#">Travel</a></li>
          <li><a class="dropdown-item" href="#">Religion and Life</a></li>
...
=======
>>>>>>> 40fa282e77d7e5e72849bfb9baf05087299a5093
